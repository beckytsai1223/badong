...
- [x] 4.1 手動測試：主辦人在私聊建立訂單後，在群組傳送 `/發布菜單`，確認群組收到菜單 Flex Message
- [x] 4.2 手動測試：非主辦人傳送 `/發布菜單`，確認收到錯誤回覆，群組不出現菜單
- [x] 4.3 手動測試：無進行中訂單時傳送 `/發布菜單`，確認收到「目前沒有開放中的訂單可以發布。」
- [x] 4.4 手動測試：主辦人傳送 `/help`，確認回覆中包含「/發布菜單 → 將菜單推送至群組（主辦人）」
